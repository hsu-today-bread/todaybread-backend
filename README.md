...
본 저장소는 2026 한성대학교 모바일 소프트웨어 캡스톤 디자인 및 포트폴리오 목적으로 공개된 기존 버전입니다.

본 저장소의 소스코드, 문서, API 구조, 데이터베이스 구조를 포함한 모든 구성 요소는 비상업적 참고 및 학습 목적으로만 사용할 수 있습니다.

상업적 이용, 서비스 운영, 재배포, 재판매, 유료 제품 또는 유료 서비스에 포함하는 행위는 허용하지 않습니다.
상업적 사용이 필요한 경우 저작권자의 사전 허가가 필요합니다.
